...
void A3mReader::__construct(Php::Parameters &params) {

    std::string a3m = params[0];

    FILE* file = fmemopen(static_cast<void *>(const_cast<char *>(a3m.c_str())), a3m.length(), "r");
